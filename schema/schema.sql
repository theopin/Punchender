...
CREATE TABLE Backers (
    email TEXT PRIMARY KEY REFERENCES Users(email) ON UPDATE CASCADE,
...
CREATE TABLE Projects (
    id INT PRIMARY KEY,
    email TEXT NOT NULL REFERENCES Creators(email) ON UPDATE CASCADE,
    ptype TEXT NOT NULL REFERENCES ProjectTypes(name) ON UPDATE CASCADE,
...
CREATE TABLE Updates (
    time TIMESTAMP,
    id INT REFERENCES Projects(id) ON UPDATE CASCADE,
